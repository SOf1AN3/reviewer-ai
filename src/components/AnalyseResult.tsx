...
function NoteGauge({ note }: { note: number }) {
  ...
  return (
    <div className="flex flex-col items-center">
      <div className="relative h-36 w-36 border-3 border-border shadow-[4px_4px_0px_var(--border)] bg-card">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          <span className={`text-4xl font-bold ${getColorClass(note)}`}>
            {note}
          </span>
    ...
    <div className="space-y-6">
      ...
      <div className="brutal-card">
        ...
        <div className="flex flex-col sm:flex-row items-start gap-6">
          ...
          <div className="flex-1">
            <p className="text-xl font-bold">{rapport.verdict}</p>
      ...
      <div className="brutal-card">
        ...
        <ul className="space-y-3">
          {rapport.points_forts.map((point, i) => (
      ...
      <div className="brutal-card">
        ...
        <ul className="space-y-3">
          {rapport.points_a_ameliorer.map((point, i) => (
            <li key={i} className="flex items-start gap-3">
